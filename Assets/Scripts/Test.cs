...
public class Test : MonoBehaviour
{
    ...
    private GeneticManager<char> ga;
    ...
    void Start()
    {
        ...
        ga = new(populationSize, targetString.Length, random, GetRandomCharacter, FitnessFunction, elitism, mutationRate);
    }
    ...
    void Update()
    {
        ...
        UpdateText(ga.BestGenes, ga.BestFitness, ga.Generation, ga.CurrentPopulation.Count, (j) => ga.CurrentPopulation[j].Genes);
    ...
    {
        float score = 0;
        DNA<char> dna = ga.CurrentPopulation[index];
